<div class="container-fluid px-4">
    ...
    <div class="card mb-4">
        ...
        <div class="card-body">
            ...
            <form action="?act=addNhatKyProcess" method="POST" enctype="multipart/form-data">

                <input type="hidden" name="MaDoan" value="<?= $_GET['MaDoan'] ?>">
                ...
                <button class="btn btn-primary">
                    <i class="fas fa-save"></i> Ghi nhật ký
                </button>
            </form>
        ...
        <div class="card-body">
            ...
            <?php else: ?>
                <?php foreach ($list as $nk): ?>
                    ...
                    <?php
                        // Xử lý tên người tạo an toàn
                        $tenNguoiTao = $nk['NguoiTao'] ?? null;

                        if (!$tenNguoiTao && !empty($nk['MaNguoiTao'])) {
                            $tenNguoiTao = "Mã NV: #" . $nk['MaNguoiTao'];
                        }

                        if (!$tenNguoiTao) {
                            $tenNguoiTao = "Không rõ";
                        }
                    ?>
                    ...
                    <div class="border rounded p-3 mb-3">
                        ...
                        <p class="text-muted small">
                            Người ghi: <?= htmlspecialchars($tenNguoiTao) ?>
                        </p>
                    </div>
